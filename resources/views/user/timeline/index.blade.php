                        ...
                        <div class="d-flex justify-content-end flex-grow-1">
                            @if (Auth::user()->is_liking($post->id))
                                ...
                                <div class="unlike">
                                    ...
                                    <i class="fav far fa-heart fa-2x" data-id="{{$post->id}}" data-name="unlike" style="cursor:pointer; color:red"></i>
                                </div>
                            @else
                                ...
                                <!--<button type="button" class="fav" data-id="{{$post->id}}">-->
                                <div class="like">
                                    <span id="count_{{$post->id}}" class="badge badge-pill badge-success">{{  $post->liking_users()->count() }}</span>
                                    <i class="fav far fa-heart fa-2x" data-id="{{$post->id}}" data-name="like" style="cursor:pointer;"></i>
                                </div>
